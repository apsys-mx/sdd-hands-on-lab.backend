...
### 10.1 AuthorTests
- [ ] Crear archivo `AuthorTests.cs` en `tests/kudos.backend.domain.tests/entities`
- [ ] Heredar de `DomainTestBase`
- [ ] Implementar SetUp con AutoFixture
- [ ] Test: `Constructor_Empty_ShouldInitializeAbstractDomainObjectProperties`
- [ ] Test: `Constructor_WithName_ShouldSetAllProperties`
- [ ] Test: `IsValid_WhenInstanceIsValid_ReturnsTrue`
- [ ] Test: `IsValid_WhenNameIsNull_ReturnsFalse`
- [ ] Test: `IsValid_WhenNameIsEmpty_ReturnsFalse`
- [ ] Test: `IsValid_WhenNameExceedsMaxLength_ReturnsFalse`
- [ ] Test: `IsValid_WhenCountryExceedsMaxLength_ReturnsFalse`
- [ ] Test: `IsValid_WhenBirthDateIsFuture_ReturnsFalse`
- [ ] Test: `Validate_WithEmptyName_ShouldReturnErrors`
- [ ] Test: `GetValidator_ShouldReturnAuthorValidator`

### 10.2 BookTests
- [ ] Crear archivo `BookTests.cs` en `tests/kudos.backend.domain.tests/entities`
- [ ] Heredar de `DomainTestBase`
- [ ] Implementar SetUp con AutoFixture
- [ ] Test: `Constructor_Empty_ShouldInitializeAbstractDomainObjectProperties`
- [ ] Test: `Constructor_WithParameters_ShouldSetAllProperties`
- [ ] Test: `IsValid_WhenInstanceIsValid_ReturnsTrue`
- [ ] Test: `IsValid_WhenTitleIsNull_ReturnsFalse`
- [ ] Test: `IsValid_WhenTitleIsEmpty_ReturnsFalse`
- [ ] Test: `IsValid_WhenTitleExceedsMaxLength_ReturnsFalse`
- [ ] Test: `IsValid_WhenISBNIsNull_ReturnsFalse`
- [ ] Test: `IsValid_WhenISBNIsEmpty_ReturnsFalse`
- [ ] Test: `IsValid_WhenISBNExceedsMaxLength_ReturnsFalse`
- [ ] Test: `IsValid_WhenAuthorIdIsEmpty_ReturnsFalse`
- [ ] Test: `IsValid_WhenCategoryExceedsMaxLength_ReturnsFalse`
- [ ] Test: `IsValid_WhenCoverImageUrlExceedsMaxLength_ReturnsFalse`
- [ ] Test: `Validate_WithMultipleInvalidProperties_ShouldReturnAllErrors`
- [ ] Test: `GetValidator_ShouldReturnBookValidator`

### 10.3 BookImageTests
- [ ] Crear archivo `BookImageTests.cs` en `tests/kudos.backend.domain.tests/entities`
- [ ] Heredar de `DomainTestBase`
- [ ] Implementar SetUp con AutoFixture
- [ ] Test: `Constructor_Empty_ShouldInitializeAbstractDomainObjectProperties`
- [ ] Test: `Constructor_WithParameters_ShouldSetAllProperties`
- [ ] Test: `IsValid_WhenInstanceIsValid_ReturnsTrue`
- [ ] Test: `IsValid_WhenBookIdIsEmpty_ReturnsFalse`
- [ ] Test: `IsValid_WhenImageUrlIsNull_ReturnsFalse`
- [ ] Test: `IsValid_WhenImageUrlIsEmpty_ReturnsFalse`
- [ ] Test: `IsValid_WhenImageUrlExceedsMaxLength_ReturnsFalse`
- [ ] Test: `Validate_WithEmptyBookId_ShouldReturnErrors`
- [ ] Test: `GetValidator_ShouldReturnBookImageValidator`

---

## 11. Repository Integration Tests

### 11.1 NHAuthorRepositoryTests
- [ ] Crear archivo `NHAuthorRepositoryTests.cs` en `tests/kudos.backend.infrastructure.tests/nhibernate`
- [ ] Heredar de `NHRepositoryTestBase<NHAuthorRepository, Author, Guid>`
- [ ] Implementar BuildRepository()
- [ ] Implementar LocalSetUp con AutoFixture
- [ ] Test: `CreateAsync_WhenNameIsValid_ShouldCreateAuthor`
- [ ] Test: `CreateAsync_WhenNameIsNull_ShouldThrowInvalidDomainException`
- [ ] Test: `CreateAsync_WhenNameIsEmpty_ShouldThrowInvalidDomainException`
- [ ] Test: `GetByNameAsync_WhenNameExists_ShouldReturnAuthor`
- [ ] Test: `GetByNameAsync_WhenNameDoesNotExist_ShouldReturnNull`
- [ ] Helper: `GetFirstAuthorNameFromDb()`

### 11.2 NHBookRepositoryTests
- [ ] Crear archivo `NHBookRepositoryTests.cs` en `tests/kudos.backend.infrastructure.tests/nhibernate`
- [ ] Heredar de `NHRepositoryTestBase<NHBookRepository, Book, Guid>`
- [ ] Implementar BuildRepository()
- [ ] Implementar LocalSetUp con AutoFixture
- [ ] Test: `CreateAsync_WhenDataIsValid_ShouldCreateBook`
- [ ] Test: `CreateAsync_WhenTitleIsNull_ShouldThrowInvalidDomainException`
- [ ] Test: `CreateAsync_WhenISBNIsDuplicated_ShouldThrowDuplicatedDomainException`
- [ ] Test: `GetByIsbnAsync_WhenIsbnExists_ShouldReturnBook`
- [ ] Test: `GetByIsbnAsync_WhenIsbnDoesNotExist_ShouldReturnNull`
- [ ] Test: `ExistsIsbnAsync_WhenIsbnExists_ShouldReturnTrue`
- [ ] Test: `ExistsIsbnAsync_WhenIsbnDoesNotExist_ShouldReturnFalse`
- [ ] Helper: `GetFirstBookIsbnFromDb()`

### 11.3 NHBookImageRepositoryTests
- [ ] Crear archivo `NHBookImageRepositoryTests.cs` en `tests/kudos.backend.infrastructure.tests/nhibernate`
- [ ] Heredar de `NHRepositoryTestBase<NHBookImageRepository, BookImage, Guid>`
- [ ] Implementar BuildRepository()
- [ ] Implementar LocalSetUp con AutoFixture
- [ ] Test: `CreateAsync_WhenDataIsValid_ShouldCreateBookImage`
- [ ] Test: `CreateAsync_WhenBookIdIsEmpty_ShouldThrowInvalidDomainException`
- [ ] Test: `CreateAsync_WhenImageUrlIsEmpty_ShouldThrowInvalidDomainException`
- [ ] Test: `GetByBookIdAsync_WhenBookIdExists_ShouldReturnBookImages`
- [ ] Test: `GetByBookIdAsync_WhenBookIdDoesNotExist_ShouldReturnEmptyList`
- [ ] Helper: `GetFirstBookIdFromDb()`

### 11.4 NHBookDaoRepositoryTests (Read-Only)
- [ ] Crear archivo `NHBookDaoRepositoryTests.cs` en `tests/kudos.backend.infrastructure.tests/nhibernate`
- [ ] Heredar de `NHReadOnlyRepositoryTestBase<NHBookDaoRepository, BookDao, Guid>`
- [ ] Implementar BuildRepository()
- [ ] Test: `GetAsync_WhenBooksExist_ShouldReturnAll`
- [ ] Test: `GetManyAndCountAsync_WithoutQuery_ShouldReturnAllBooks`
- [ ] Test: `GetManyAndCountAsync_WithQuery_ShouldReturnFilteredBooks`
- [ ] Test: `GetManyAndCountAsync_WithQuery_IsCaseInsensitive`

### 11.5 Update ScenarioBuilder for Tests
- [ ] Agregar escenario `Sc020CreateAuthors` al ScenarioBuilder
- [ ] Agregar escenario `Sc030CreateBooks` al ScenarioBuilder

---

## 12. WebAPI Integration Tests

### 12.1 GetManyAndCountBooksEndpointTests
- [ ] Crear archivo `GetManyAndCountBooksEndpointTests.cs` en `tests/kudos.backend.webapi.tests/features/books`
- [ ] Heredar de `EndpointTestBase`
- [ ] Test: `GetBooks_WithoutFilters_ReturnsAllBooksInPage`
- [ ] Test: `GetBooks_WithQueryFilter_ReturnsFilteredBooks`
- [ ] Test (TestCase): `GetBooks_WithQueryFilter_IsCaseInsensitive`
- [ ] Test: `GetBooks_WithPagination_ReturnsCorrectPage`
- [ ] Test: `GetBooks_WithSorting_ReturnsSortedBooks`
- [ ] Test: `GetBooks_WithNoResults_ReturnsEmptyList`
- [ ] Test: `GetBooks_WithoutAuthentication_ReturnsUnauthorized`
- [ ] Helper: `AssertBooksResponseValid()`

---

## 13. Mapping Profile Tests

### 13.1 BookMappingProfileTests
- [ ] Crear archivo `BookMappingProfileTests.cs` en `tests/kudos.backend.webapi.tests/mappingprofiles`
- [ ] Heredar de `BaseMappingProfileTests`
- [ ] Implementar `ConfigureProfiles()` con `BookMappingProfile`
- [ ] Test: `MappingConfiguration_ShouldBeValid` (heredado de base)
- [ ] Test: `BookDaoToBookDto_WhenAllPropertiesAreSet_ShouldMapCorrectly`
- [ ] Test: `BookDaoToBookDto_WithNullableProperties_ShouldHandleNulls`
- [ ] Test: `GetManyAndCountResultToDto_WhenAllPropertiesAreSet_ShouldMapCorrectly`
